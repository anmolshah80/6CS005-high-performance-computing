...
// strcpy(), a C function that cannot be used in GPU/device
...
int main(int argc, char ** argv){
	...
	/*
	* // optional (sort of alternative) way of doing the similar thing with less code (less variables) obviously
