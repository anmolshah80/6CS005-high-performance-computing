...
void main()
{
    ...
    if (fp1 != NULL && fp2 != NULL)
    {
        ...
        p = find_number_of_rows_and_columns("Mat1.txt");
        ...
        q = find_number_of_rows_and_columns("Mat2.txt");
        ...
        if (cols_in_matrixA == rows_in_matrixB)
        {
            ...
            // algorithm created to multiply Matrix A and Matrix B resulting in as Matrix C
        ...
        {
            printf("\nOops! the column of matrix A is not equal to the row of matrix B.\n");
        }
