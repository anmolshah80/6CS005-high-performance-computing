...
void main(int argc, char *argv[])
{
    ...
    char *output_matrix_filename = "output.txt";
    ...
    if (fp1 != NULL && fp2 != NULL && fp3 != NULL)
    {
        ...
        if (cols_in_matrixA == rows_in_matrixB)
        {
            ...
            // writing the output matrix C into the file `output.txt`
            ...
            printf("Output matrix elements written in the file `output.txt`\n\n");
