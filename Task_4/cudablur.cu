...
int main(int argc, char **argv)
{
	...
	unsigned int width;
	unsigned int height;
	const char *input_filename = "hck.png";
	const char *output_filename = "hck_blurred.png";
	...
	printf("\nBlurred image is saved in the same directory under the name `hck_blurred.png\n\n");
